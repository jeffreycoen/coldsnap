...
| T11 | 0.4.9 | Each leg solves its own ground — the shared ground reference becomes the mean of the two loaded soles, and every foot target (standing, the walk's swing landings, the leap's grounded phases) takes the terrain height under its own print; a broken leap landing squares itself — for three seconds after the catch, the stand watches the stance's shape and resteps a crossed, pinched, or badly twisted foot out to square once the frame is upright and quiet | LANDED d0ae9f9 (12-the-mech.mjs 25 PASS, 0 FAIL; depot-test 1615 PASS, 0 FAIL; smoke 23 PASS, 0 FAIL) |
...
| T15 | 0.4.13 | The phase closeout: the record re-measured, the README's claims re-checked against the shipped game, the phase document closed | LANDED 87d7867 |
