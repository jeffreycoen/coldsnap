...
| T7 | 0.3.17 | The comment trim, mechanical: every task/phase/mark stamp prefix deleted; comment blocks carrying no constraint deleted; every deletion reported | LANDED, commit 07f898f, depot-test 1,615 PASS / 0 FAIL, golden 7 PASS / 0 FAIL, smoke 30 PASS / 0 FAIL. Line counts old→new: DepotGame.jsx 2,427→2,422; hooks.js 345→345; styles.js 22→22; palette.js 107→104; RadialMenu.jsx 62→61; DraftScreen.jsx 49→49; pies.jsx 162→162; placement.js 484→483; orders.js 818→817. |
