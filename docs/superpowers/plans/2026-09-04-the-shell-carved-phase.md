...
| depot-test | 2,163 PASS / 0 FAIL (re-measured at the T1 landing; 2,207 → 2,198 at the T3 landing, amendment 1 — nine source-text pins retired; 2,198 → 2,163 at the T4 landing, amendment 1 — thirty-five source-text pins retired) |
| golden | 7 PASS |
| smoke | 30 PASS |
