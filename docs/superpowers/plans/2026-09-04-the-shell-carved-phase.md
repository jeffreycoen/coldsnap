...
| T6 | 0.3.16 | The selection and order layer out: the tap cycle, the order taps, the line flow, possession take/release, and the chain controls, same builder idiom | LANDED, commit PENDING, depot-test 1,615 PASS / 0 FAIL, golden 7 PASS / 0 FAIL, smoke 30 PASS / 0 FAIL |
