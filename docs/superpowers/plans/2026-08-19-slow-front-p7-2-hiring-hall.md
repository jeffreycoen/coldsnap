...
*The skeleton. Scope and all design rulings: `docs/superpowers/decision-record.md`, the 2026-08-19 first-pass and second-pass entries plus the 2026-08-20 convoy rulings. Eight tasks, marks mk1.80–mk1.88 (mk1.83 = the wall-clock arming amendment), easier selection first (owner's ordering); the calm window inserted third off the mk1.81 live check (owner). Each task's full plan is its own file, written one at a time on the owner's word and served alone for review. Resource harvesting is NOT here — it is Phase 7.3. ARMS follows 7.3.*
...
| 4 | His hand | mk1.84 | `p7-2-task-4-his-hand.md` | pending |
| 5 | The volunteer | mk1.85 | `p7-2-task-5-volunteer.md` | pending |
| 6 | The medic | mk1.86 | `p7-2-task-6-medic.md` | pending |
| 7 | The mechanic | mk1.87 | `p7-2-task-7-mechanic.md` | pending |
| 8 | The mech | mk1.88 | `p7-2-task-8-mech.md` | pending |
