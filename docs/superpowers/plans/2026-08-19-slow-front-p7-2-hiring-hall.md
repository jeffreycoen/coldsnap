...
*The skeleton. Scope and all design rulings: `docs/superpowers/decision-record.md`, the 2026-08-19 first-pass and second-pass entries plus the 2026-08-20 convoy rulings. Eight tasks, marks mk1.80–mk1.87, easier selection first (owner's ordering); the calm window inserted third off the mk1.81 live check (owner). Each task's full plan is its own file, written one at a time on the owner's word and served alone for review. Resource harvesting is NOT here — it is Phase 7.3. ARMS follows 7.3.*
...
| 7 | The mechanic | mk1.86 | `p7-2-task-7-mechanic.md` | pending |
| 8 | The mech | mk1.87 | `p7-2-task-8-mech.md` | pending |
