...
| T29 | 0.5.28 | Ship modules carry health and die. A strike wounds once, at first touch, by its closing speed past a graze of 40, times 1.0, capped at 55 per module per frame, with a 30-frame cooldown per module; hull-on-hull contact stays the weld's law, never a wound. Burns land only on the hull still welded to the cabin, and need an engine inside that connected hull. The cabin's death ends the flight with a report card; the wreck keeps drifting | LANDED 355f475 — smoke 23 PASS, 0 FAIL — evolution hash 42ae90b308d1e6f6 unchanged — ship re-pin old 65750510510dc87a to new c2538ff163ef1494 |
| T30 | 0.5.29 | The ship scene learns the deadweight hangar's eight ship shapes, copied cell for cell: STARTER, COURIER, LONG-RANGE, HAULER, WING TURNER, GUNBOAT, CATAMARAN, GRAPPLER. Each shows as a chip while aiming; picking one rebuilds the scene with that ship. The bridge cell is the cabin, engine cells are engines, tank cells are tanks; every other part rides as a plain hull block. Fuel lives in the tanks: 100 in the cabin plus 210 per tank still welded to the cabin — LONG-RANGE keeps its 520, GRAPPLER carries 310, the other six fly on 100 alone. A tank lost or torn off spills its share the moment it goes. Every living engine now fires its plume, so the two-engine ships (COURIER, CATAMARAN, GRAPPLER) burn from both | LANDED 3572f53 — smoke 23 PASS, 0 FAIL — evolution 10s hash=false 42ae90b308d1e6f6 — evolution 10s hash=true 42ae90b308d1e6f6 unchanged — ship re-pin old c2538ff163ef1494 to new 3f0c91218aef32ab — eight hulls newly pinned: starter 374fecf6f586cccf, courier 5c4da345a9a7e13a, longrange 3f0c91218aef32ab, hauler 6b2227e0347049a7, wingturner a6c0bbe05e44afab, gunboat 2eea91f5ce0187bb, catamaran 1b923aac0b754363, grappler f734aeff3852b564 |
| T31 | 0.5.30 | A ship never sleeps: the calm-clump sleep rule now excludes any clump holding a ship block, fixing the eleven-block catamaran freezing into a stone that ignored its burns. The hull turns with the trajectory line: while time is frozen for aiming or planning, the connected hull rotates rigidly about its own center to face the aim, positions only, speeds untouched | LANDED be53937 — smoke 23 PASS, 0 FAIL — evolution 10s hash=false 42ae90b308d1e6f6 — evolution 10s hash=true 42ae90b308d1e6f6 unchanged — ship s1 3f0c91218aef32ab — binary s1 1ab5dec0a100e39f — duet s1 815c1643021c10c9 — moons s1 55e26401d110fa2c — trio s1 7cbf8f6bbd428266 — system s1 1bbb5a4a3205c09c — hole s1 cae5ebf64cc05676 — catamaran burn: conn 11 of 11 welds 14 minHp 100 speed 32 |
| T32 | 0.5.31 | Every scene can carry the flyable ship. A FLY chip joins the scene row; turned on, the scene rebuilds with the chosen hull sitting clear of the bodies, aiming from birth. Without a gate the birth aim points away from the mass at strength 50. The hole scene with the ship aboard is a real mission | LANDED 68bc0e24d860b1efd002e9c347a76a1afb65fab2 — smoke 23 PASS, 0 FAIL — evolution 10s hash=false 42ae90b308d1e6f6 — evolution 10s hash=true 42ae90b308d1e6f6 unchanged — ship s1 3f0c91218aef32ab — binary s1 1ab5dec0a100e39f — duet s1 815c1643021c10c9 — moons s1 55e26401d110fa2c — trio s1 7cbf8f6bbd428266 — system s1 1bbb5a4a3205c09c — hole s1 cae5ebf64cc05676 unchanged — six ship-on numbers newly pinned: binary ship-on s1 b08ee285055dfcef clear 65, duet ship-on s1 7f5f21baa3a151db clear 164, moons ship-on s1 9aa0e9e699ec99c5 clear 151, trio ship-on s1 23d653245a5a6ed8 clear 143, system ship-on s1 b99153fd37941d4c clear 52, hole ship-on s1 6b4ae943af3aefc6 clear 223 |
