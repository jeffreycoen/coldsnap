...
- **SYMMETRY IS LAW.** Whatever one side can do, buy, build, or suffer, the other can — units, towers, prices, machinery, all of it. No plan may introduce an asymmetry, even a small or temporary one, as the plan-writer's own choice: every asymmetry requires the owner's explicit ruling, is recorded as knowing with its closing task named, and a plan that finds symmetry inconvenient asks instead of carving an exception.
